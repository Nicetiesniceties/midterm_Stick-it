...
var nicEditorConfig = bkClass.extend({
	...
	buttonList : ['save','bold','italic','underline','ol','ul','fontSize','forecolor'],
...
var nicEditor = bkClass.extend({
	...
	//document.getElementById('displayBox').select();
		...
		if(this.selectedInstance) {
			...
			// set all content selected on the fly
			// watch/step through menu
		
			//document.getElementById('displayBox').innerHTML;
		
			this.selectedInstance.nicCommand(cmd,args);
			//log.debug('nicCommand');
		}
	},
...
var nicEditorButton = bkClass.extend({
	...
	setBg : function(state) {
		switch(state) {
			case 'hover':
				var stateStyle = {border : '1px solid #555555', backgroundColor : '#555555'};
				break;
			case 'active':
				var stateStyle = {border : '1px solid #888888', backgroundColor : '#888888'};
				break;
			default:
				var stateStyle = {border : '1px solid #000000', backgroundColor : '#000000'};	
		}
	...
	//log.debug(this.options.commandArgs);
	...
	mouseClick : function() {
		if(!this.isDisabled) {
			if(this.pane && this.pane.pane) {
				...
				this.pane = new nicEditorPane(this.contain,this.ne,{width : (this.width || '240px'), backgroundColor : '#fff'},this);
				this.addPane();
...
var nicEditorColorButton = nicEditorAdvancedButton.extend({	
	addPane : function() {
			...
			var colorItems = new bkElement('DIV').setStyle({width: '240px'});
			var colorList = {	0 : '#000000',	// black
								1 : '#FFFFFF',	// white
								2 : '#FFFF66',	// yellow
								3 : '#92FF8A',	// teal
								4 : '#76D9FF',	// blue
